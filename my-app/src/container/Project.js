                ...
                <div style={{ marginLeft: '15%', marginRight: '15%', marginTop: 30 }}>
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            : outdated === 'true' && <div style={{ borderRadius: 15, border: '2px solid #E46117', marginLeft: 15, paddingTop: 5, paddingBottom: 5, paddingLeft: 10, paddingRight: 10, height: 35, color: '#E46117', fontSize: 12 }}> Desatualizado </div>
                            }
                        ...
                        { category !== '-' && <div style={styles.category}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 15 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row' }}>
                            ...
                            {showInfoHover && <div style={{ position: 'absolute', background: '#F1F1F1', padding: 5, paddingLeft: 10, paddingRight: 10, borderRadius: 10, marginLeft: -120 }}>
                                { finished === 'true' ? 'Tempo em que o projeto ficou em curso' : 'Ano estimado para a conclusão' }
                            </div>}
                            </div>
                        </div>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 15 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row' }}>
                            ...
                            {token && <a onClick={this.showInterest} style={{ marginLeft: 10, cursor: 'pointer', color: 'black' }}>
                                {!isAuthor && (isInterested === 'true' ? <Icon name='star'/> : <Icon name='star outline'/>)}
                            </a>}
                        </div>
                    </div>
                    ...
                    :
                        <div style={{marginTop: 40, marginBottom: 40}}>
                            ...
                            <div>
                                ...
                                ? <p style={{ textAlign: 'center', fontSize: 18, color: '#586073' }}> Nenhum documento relacionado </p>
