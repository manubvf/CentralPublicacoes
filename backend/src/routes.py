...
def update_publication():
    ...
    return Central.updatePublication(idPublicacao, titulo, descricao, idCategoria, ano_inicio, idTag_1, idTag_2, idTag_3, git, autores)
...
def backend_update_publication():
